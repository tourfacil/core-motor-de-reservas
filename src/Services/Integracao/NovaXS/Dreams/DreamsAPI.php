...
class DreamsAPI
{
    ...
    /**
     * URL base da API do Dreams usada tbm para impressao do voucher
     *
     * @var string
     */
    protected $base_url;
    ...
    public function __construct() {
        ...
        $this->login = config('integracao.dreams.login');
        $this->password = config('integracao.dreams.password');
        $this->token = config('integracao.dreams.token');
        $this->base_url = config('integracao.base_url');

        $this->url = $this->base_url . config('integracao.dreams.suffix_url');
    }
