...
class NBAParkAPI
{
    ...
    public function __construct() {
        ...
        $this->login = config('integracao.nba_park.login');
        $this->password = config('integracao.nba_park.password');
        $this->token = config('integracao.nba_park.token');
        $this->base_url = config('integracao.nba_park.base_url');

        $this->url = $this->base_url . config('integracao.nba_park.suffix_url');
    }
