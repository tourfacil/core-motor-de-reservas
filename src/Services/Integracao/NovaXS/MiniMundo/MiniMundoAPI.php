...
class MiniMundoAPI
{
    ...
    /**
     * URL base da API do MiniMundo usada tbm para impressao do voucher
     *
     * @var string
     */
    protected $base_url;
    ...
    public function __construct() {
        ...
        $this->login = config('integracao.minimundo.login');
        $this->password = config('integracao.minimundo.password');
        $this->token = config('integracao.minimundo.token');
        $this->base_url = config('integracao.base_url');

        $this->url = $this->base_url . config('integracao.minimundo.suffix_url');
    }
    ...
    /**
     * Solicita a compra para o MiniMundo
     *
     * @param array $dados
     * @return mixed|string
     */
    ...
    /**
     * Confirma a compra para o MiniMundo
     *
     * @param array $dados
     * @return mixed|string
     */
    ...
    /**
     * Recupera a lista de viajantes para o MiniMundo
     *
     * @param array $dados
     * @return mixed
     */
