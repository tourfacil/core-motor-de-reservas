...
class AcquaMotionAPI
{
    ...
    public function __construct() {
        ...
        $this->login = config('integracao.acqua_motion.login');
        $this->password = config('integracao.acqua_motion.password');
        $this->token = config('integracao.acqua_motion.token');
        $this->base_url = config('integracao.acqua_motion.base_url');

        $this->url = $this->base_url . config('integracao.acqua_motion.suffix_url');
    }
