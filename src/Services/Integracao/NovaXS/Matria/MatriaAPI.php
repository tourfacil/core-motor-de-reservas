...
class MatriaAPI
{
    ...
    public function __construct() {
        ...
        $this->login = config('integracao.matria.login');
        $this->password = config('integracao.matria.password');
        $this->token = config('integracao.matria.token');
        $this->base_url = config('integracao.matria.base_url');

        $this->url = $this->base_url . config('integracao.matria.suffix_url');
    }
