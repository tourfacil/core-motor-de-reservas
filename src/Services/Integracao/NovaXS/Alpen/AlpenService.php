...
class AlpenService
{
     ...
     * @throws Exception
     */
    public function gerarVoucherAlpen()
    {
        // Recupera os serviços disponível para a data do serviço
        $this->servicosDisponiveis = $this->alpen->getProductsByDate([
        ...
        // Bloqueio de compra
        $this->buyToBillFor = $this->alpen->buyToBillFor([
        ...
        $this->billFor = $this->alpen->billFor([
        ...
        $this->getAccessList = $this->alpen->getAccessList([
            'bill' => $this->buyToBillFor['id']
        ]);
    ...
    private function filterServicoAlpen() {
    ...
    public function cancelarVoucher(AlpenReservaPedido $alpenReservaPedido)
    {
        ...
        $cancelado = $this->alpen->cancelBill([
