...
class VilaDaMonicaService
{
    /** @var VilaDaMonicaAPI */
    protected $vila_da_monica;
    ...
    /** @var string  */
    protected $path = "integracao/vila_da_monica/";
    ...
    public function __construct(ReservaPedido $reservaPedido)
    {
        ...
        $this->vila_da_monica = new VilaDaMonicaAPI();
        // Nome do log
     ...
     * @throws Exception
     */
    public function gerarVoucherVilaDaMonica()
    {
        // Recupera os serviços disponível para a data do serviço
        $this->servicosDisponiveis = $this->vila_da_monica->getProductsByDate([
        ...
        $this->billFor = $this->vila_da_monica->billFor([
        ...
        $this->getAccessList = $this->vila_da_monica->getAccessList([
            'bill' => $this->buyToBillFor['id']
        ]);
    ...
    private function filterServicoVilaDaMonica() {
    ...
    private function productsArray() {
        ...
        $this->filterServicoVilaDaMonica();
...
//                }
    ...
    public function cancelarVoucher(VilaDaMonicaReservaPedido $olivasReservaPedido)
    {
        ...
        $cancelado = $this->vila_da_monica->cancelBill([
