...
class Payload
{
    ...
    /**
     * Define se o pagamento deve ser pago apenas uma vez
     * @var boolean
     */
    ...
    /**
     * Método responsavel por retornar o valor completo de um objeto do payload
     * @param string $id
     * @param string $value
    ...
    private function getMerchantAccountInformation()
    {
        ...
        $key = mb_strlen($this->pixKey) ? $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION_KEY, $this->pixKey) : '';
